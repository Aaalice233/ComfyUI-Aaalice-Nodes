...
| 文件 | 职责 | 禁止内容 |
|---|---|---|
| `README.md` / `README.zh-CN.md` | 面向用户的安装、功能、用法、公开限制、重置进度与节点清单 | 协作规则、测试记录、开发流水账 |
...
- README 必须维护当前重置进度、下一项、稳定编号队列、已注册节点及节点介绍；完成节点重置或增删节点时必须同步更新两份 README。
...
- [ ] 节点重置或增删后，双语 README 的进度、队列、节点清单和介绍已同步
