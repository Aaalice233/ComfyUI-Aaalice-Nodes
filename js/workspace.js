...
import {
	bindingKey, createPage, DASHBOARD_TONES, emptyDashboard, normalizeDashboard,
...
function openCardActions({ x, y, editMode: layoutEditing, onMove, onRemove, onToggleSpan, onGroup, onUngroup }, item) {
	const items = [];
