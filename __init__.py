...
- i18n：`locales/{en,zh,zh-TW}/` 由 ComfyUI 扫描 `/api/i18n` 合并，无需在此注册
"""
...
async def comfy_entrypoint() -> AaaliceNodesExtension:
    ...
    from .nodes.tools.discord_share_routes import register_discord_share_routes
    from .nodes.tools.image_thumbnail_routes import register_image_thumbnail_routes
    ...
    register_discord_share_routes()
    register_image_thumbnail_routes()
