import { corsHeaders, errorResponse, isAllowedOrigin, json } from "./http.js";
...
export function defaultDiscordAvatarUrl(userId) {
	try {
...
export function discordMemberAvatarUrl(member, userId, guildId) {
...
export async function handleOAuthResult(request, env) {
