...
const layout = (column = 0) => ({
	version: 2,
	pages: [{ id: "page-a", name: "Main", gridColumns: 12, groups: [], items: [{ id: "item-a", kind: "control", binding, label: "Steps", groupId: null, compact: false, layout: { row: 0, column, columnSpan: 6, rowSpan: 7 } }] }],
});
